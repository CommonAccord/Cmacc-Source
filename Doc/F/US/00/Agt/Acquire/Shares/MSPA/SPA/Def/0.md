...
Applicable_Contract.=[F/US/00/Agt/Acquire/Shares/MSPA/SPA/Def/Applicable_Contract/0.md]

Balance_Sheet_Date.Def="{_Balance_Sheet_Date}" - as defined in {Rep.Seller.FinancialStatements.Xref}.

Breach.=[F/US/00/Agt/Acquire/Shares/MSPA/SPA/Def/Breach/0.md]

Business_Day.=[F/US/00/Agt/Acquire/Shares/MSPA/SPA/Def/Business_Day/0.md]
...
Facilities.=[F/US/00/Agt/Acquire/Shares/MSPA/SPA/Def/Facilities/0.md]
...
Legal_Requirement.Def="{_Legal_Requirement}" - any constitution, law, ordinance, principle of common law, code, rule, regulation, statute, act, treaty, or order of general applicability of any {_Governmental_Body}, including rules and regulations promulgated thereunder.
...
Subsidiary.=[F/US/00/Agt/Acquire/Shares/MSPA/SPA/Def/Subsidiary/0.md]
