...
0.1.1.sec=Space No.		(“Space”).  

0.1.2.sec=This agreement (“Agreement”) is entered into this _____ day of _______________, 20_____ by and between the park owner (“Lessor”) of _______________________________________ (park name), located at:____________________________________________________________(park address) and Tenant(s) (names):______________________________________(severally and collectively “Tenant”). Household Members (list all):___________________________________________________________
...
0.1.3.1.sec=[____] month to month; (or) 

0.1.3.2.sec=[____] # of months (not to exceed 8 months), unless sooner terminated in accordance with the terms and conditions of this agreement.

0.1.4.sec=Security Deposit: $____________________

0.1.5.sec=Beginning Monthly Rent: $___________________ (Please note: rent may be increased during term with 30 days’ notice)
...
0.2.1.sec=Registered Owner:											

0.2.2.sec=Address:												

0.2.3.sec=Telephone Number:											

0.2.4.sec=Legal Owner:												

0.2.5.sec=Address:												

0.2.6.sec=Telephone:												

0.2.7.sec=Make of RV												

0.2.8.sec=Year/Model of RV											

0.2.9.sec=Vehicle ID Nos.											

0.2.10.sec=License/Decal Nos.											
...
3.1.sec=A. Lessor reserves the right to submeter and charge separately for any utility or other charge included in rent. Billed submetered/separately charged utilities reflect charges for usage based on a closing meter reading taken at the space.
