...
Applicable_Contract.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Applicable_Contract/0.md]

Balance_Sheet_Date.Def="{_Balance_Sheet_Date}" - as defined in {Rep.Seller.FinancialStatements.Xref}.

Breach.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Breach/0.md]

Business_Day.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Business_Day/0.md]
...
Contract.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Contract/0.md]
...
Encumbrance.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Encumbrance/0.md]

End_Date.Def="{_End_Date}" - as defined in {Life.Terminate.Event(d).Xref}.

Environment.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Environment/0.md]
...
Environmental_Law.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Environmental_Law/0.md]

Equity_Security.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Equity_Security/0.md]
...
Facilities.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Facilities/0.md]
...
Governmental_Authorization.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Governmental_Authorization/0.md]

Governmental_Body.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Governmental_Body/0.md]

Hazardous_Activity.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Hazardous_Activity/0.md]
 
Hazardous_Material.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Hazardous_Material/0.md]
...
Knowledge.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Knowledge/0.md]
...
Legal_Requirement.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Legal_Requirement/0.md]
...
Material_Adverse_Change.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Material_Adverse_Change/0.md]
...
Occupational_Safety_and_Health_Law.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Occupational_Safety_and_Health_Law/0.md]
...
Ordinary_Course_of_Business.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Ordinary_Course_of_Business/0.md]

Organizational_Documents.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Organizational_Documents/0.md]
...
Permitted_Encumbrances.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Permitted_Encumbrances/0.md]

Person.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Person/0.md]

Plan.Def="{_Plan}" - as defined in {Rep.Seller.EmployeeBenefits.Xref}.

Proceeding.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Proceeding/0.md]
...
Related_Person.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Related_Person/0.md]
...
Representative.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Representative/0.md]
...
Subsidiary.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Subsidiary/0.md]

Tax.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Tax/0.md]

Tax_Return.=[G/CmA_F_ABA-MSPA-SPA/Sec/Def/Tax_Return/0.md]
