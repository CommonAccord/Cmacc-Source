...
Def.sec={Def.0.sec}<ul class="secs-and"><li>{Def.Personal_Data.sec}<li>{Def.Data_Non-Compliance.sec}<li>{Def.Data_Loss.sec}</ul>
...
Concept.xlist=<ul class="secs-and"><li>{Concept.secs}</ul>
